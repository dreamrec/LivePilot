...
LivePilot gives you 472 tools that control every part of Ableton Live 12. You don't call these tools directly -- you describe what you want in plain language, and the AI picks the right tools behind the scenes. But knowing what's available helps you ask better questions and understand what's happening when the AI works on your session.

This chapter covers the most-used tools, grouped by what it does. Each entry tells you the tool name, what it does in practice, what parameters it accepts, and when you'd want it. The complete list of all 472 tools is auto-generated in the **[Tool Catalog](tool-catalog.md)**.
