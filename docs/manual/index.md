...
427 tools. 52 domains. Device atlas. Sample intelligence. Auto-composition. Spectral perception. Technique memory. Creative intelligence.

---

## What LivePilot Is

LivePilot is not a tool collection with an AI wrapper. It is a **production system** — three perception layers feed into 427 tools, which are orchestrated by a dozen creative engines that understand song identity, learn your taste, diagnose session problems, and generate real musical options.
...
All 427 tools execute as deterministic LOM calls on Ableton's main thread. Everything is reversible with undo.
...
All 427 tools across 52 domains, in source-truth per-domain counts:
