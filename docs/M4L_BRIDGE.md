...
The bridge is optional. All 207 core tools work without it. The 30 analyzer tools require the device on the master track.
...
|---------|------|-------------|
| `ping` | (none) | Health check, returns `{ok: true, version: "1.9.24"}` |
