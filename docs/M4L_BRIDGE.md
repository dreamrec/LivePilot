...
The bridge is optional. All 107 core tools work without it. The 20 analyzer tools require the device on the master track.
...
|---------|------|-------------|
| `ping` | (none) | Health check, returns `{ok: true, version: "1.0.0"}` |
