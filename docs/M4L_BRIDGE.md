...
The bridge is optional. All 281 core tools work without it. The 36 bridge tools (backed by 27 bridge commands) require the device on the master track.
...
|---------|------|-------------|
| `ping` | (none) | Health check, returns `{ok: true, version: "1.10.7"}` |
