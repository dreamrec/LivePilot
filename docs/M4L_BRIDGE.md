...
The bridge is optional. All 139 core tools work without it. The 29 analyzer tools require the device on the master track.
...
## Bridge Commands (22 total)

### Phase 1: Core LOM Access

| Command | Args | Description |
|---------|------|-------------|
| `ping` | (none) | Health check, returns `{ok: true, version: "1.9.11"}` |
