...
|---------|------|-------------|
| `ping` | (none) | Health check, returns `{ok: true, version: "1.17.1"}` |
...
- `m4l_device/LivePilot_Analyzer.amxd` — compiled M4L device (binary). Ping returns `{ok: true, version: "1.17.1"}`
