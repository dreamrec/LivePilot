...
_DESIGN_TARGETS = (
    ...
    "the song. Use the event_lexicon as inspiration for named structural "
    "moves, then translate every chosen move into concrete arrangement clips, "
    "device parameters, sends, or automation at phrase boundaries. "
    "compose_full_apply rejects abstract `events` because silently accepting "
    "unapplied musical ideas creates false confidence. For niche style references "
    ...
    "referencing those variants, plus concrete effects/sends/automation for "
    "structural movement. The form is YOUR creative product — vocabularies tell you "
