---
name: livepilot-core
description: Core discipline for LivePilot — agentic production system for Ableton Live 12. 321 tools across 43 domains. This skill should be used whenever working with Ableton Live through MCP tools. Provides golden rules, tool speed tiers, error handling protocol, and pointers to domain and engine skills.
---

# LivePilot Core — Ableton Live 12

Agentic production system for Ableton Live 12. 321 tools across 43 domains, three layers:
...
All 321 tools plus M4L perception tools.
...
| File | Content |
|------|---------|
| `references/overview.md` | All 321 tools with params and ranges |
