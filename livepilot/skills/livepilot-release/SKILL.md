...
Current: **465 tools across 55 domains**.
...
- [ ] `README.md` — header ("465 tools. 55 domains"), bridge section ("38 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "465 tools across 55 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 55 domains listed, all 465 tools present
