...
Current: **398 tools across 52 domains**.
...
- [ ] `README.md` — header ("398 tools. 52 domains"), bridge section ("32 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "398 tools across 52 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 52 domains listed, all 398 tools present
