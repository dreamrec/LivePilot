...
Current: **194 tools across 17 domains**.
...
- [ ] `package.json` → `"description"` (194 tools, 17 domains)
...
- [ ] `CLAUDE.md` → "194 tools across 17 domains"
- [ ] `livepilot/skills/livepilot-core/SKILL.md` — "194 tools across 17 domains", Analyzer (29), Perception (4)
- [ ] `livepilot/skills/livepilot-core/references/overview.md` — "194 tools across 17 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 17 domains listed, all 194 tools present
