...
Current: **470 tools across 56 domains**.
...
- [ ] `README.md` — header ("470 tools. 56 domains"), bridge section ("38 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "470 tools across 56 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 56 domains listed, all 470 tools present
