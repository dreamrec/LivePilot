...
Current: **398 tools across 51 domains**.
...
- [ ] `README.md` — header ("398 tools. 51 domains"), bridge section ("32 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "398 tools across 51 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 51 domains listed, all 398 tools present
- [ ] `docs/TOOL_REFERENCE.md` — all 51 domains present with correct counts
