...
Current: **469 tools across 57 domains**.
...
- [ ] `README.md` — header ("469 tools. 57 domains"), bridge section ("38 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "469 tools across 57 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 57 domains listed, all 469 tools present
