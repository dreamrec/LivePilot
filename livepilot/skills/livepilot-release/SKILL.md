...
Current: **231 tools across 32 domains**.
...
- [ ] `package.json` → `"description"` (231 tools, 32 domains)
...
- [ ] `CLAUDE.md` → "231 tools across 32 domains"
- [ ] `livepilot/skills/livepilot-core/SKILL.md` — "231 tools across 32 domains", Analyzer (29), Perception (4)
- [ ] `livepilot/skills/livepilot-core/references/overview.md` — "231 tools across 32 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 32 domains listed, all 231 tools present
