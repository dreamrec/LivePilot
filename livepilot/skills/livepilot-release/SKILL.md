...
Current: **459 tools across 55 domains**.
...
- [ ] `README.md` — header ("459 tools. 55 domains"), bridge section ("38 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "459 tools across 55 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 55 domains listed, all 459 tools present
