...
Current: **397 tools across 51 domains**.
...
- [ ] `README.md` — header ("397 tools. 51 domains"), bridge section ("32 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "397 tools across 51 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 51 domains listed, all 397 tools present
