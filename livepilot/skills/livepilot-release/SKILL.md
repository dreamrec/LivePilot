...
Current: **415 tools across 52 domains**.
...
- [ ] `README.md` — header ("415 tools. 52 domains"), bridge section ("32 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "415 tools across 52 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 52 domains listed, all 415 tools present
