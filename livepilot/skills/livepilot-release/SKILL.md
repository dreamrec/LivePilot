...
Current: **181 tools across 17 domains**.
...
- [ ] `package.json` → `"description"` (181 tools, 17 domains)
...
- [ ] `CLAUDE.md` → "181 tools across 17 domains"
- [ ] `livepilot/skills/livepilot-core/SKILL.md` — "181 tools across 17 domains", Analyzer (29), Perception (4)
- [ ] `livepilot/skills/livepilot-core/references/overview.md` — "181 tools across 17 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 17 domains listed, all 181 tools present
