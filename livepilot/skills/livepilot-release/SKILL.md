...
Current: **492 tools across 56 domains**.
...
- [ ] `README.md` — header ("492 tools. 56 domains"), bridge section ("38 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "492 tools across 56 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 56 domains listed, all 492 tools present
