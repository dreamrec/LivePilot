...
Current: **429 tools across 53 domains**.
...
- [ ] `README.md` — header ("429 tools. 53 domains"), bridge section ("32 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "429 tools across 53 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 53 domains listed, all 429 tools present
