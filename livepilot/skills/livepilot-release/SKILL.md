...
Current: **402 tools across 52 domains**.
...
- [ ] `README.md` — header ("402 tools. 52 domains"), bridge section ("32 spectral/analyzer tools require bridge")
...
- [ ] `CLAUDE.md` → "402 tools across 52 domains"
...
- [ ] `docs/manual/tool-reference.md` — all 52 domains listed, all 402 tools present
- [ ] `docs/TOOL_REFERENCE.md` — all 52 domains present with correct counts
