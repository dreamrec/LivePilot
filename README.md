...
<p align="center">
  ...
  290 tools. Device atlas. Spectral perception. Technique memory.
</p>
...
All three feed into 289 deterministic tools that execute on Ableton's main thread.
...
290 tools across 39 domains. Highlights below — [full catalog here](docs/manual/tool-catalog.md).
...
> **[View all 290 tools →](docs/manual/tool-catalog.md)**
