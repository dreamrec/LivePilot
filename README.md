...
<p align="center">
  ...
  493 tools. 56 domains. Device atlas. Plan-aware Splice integration. Auto-composition. Spectral perception. Technique memory. Drum-rack pad builder. Live dead-device detection.
</p>
...
Pick whichever is faster for the idea in your head — both reach the same 493-tool surface.
...
12 engines sit on top of the 493 tools. They give the AI musical judgment, not just musical execution.
...
493 tools across 56 domains. Highlights below — [full catalog here](docs/manual/tool-catalog.md).
...
> **[View all 493 tools →](docs/manual/tool-catalog.md)**
...
|----------|---------------|
| [Manual](docs/manual/index.md) | Complete reference: architecture, all 493 tools, workflows |
