...
<p align="center">
  ...
  492 tools. 56 domains. Device atlas. Plan-aware Splice integration. Auto-composition. Spectral perception. Technique memory. Drum-rack pad builder. Live dead-device detection.
</p>
...
Pick whichever is faster for the idea in your head — both reach the same 492-tool surface.
...
12 engines sit on top of the 492 tools. They give the AI musical judgment, not just musical execution.
...
492 tools across 56 domains. Highlights below — [full catalog here](docs/manual/tool-catalog.md).
...
> **[View all 492 tools →](docs/manual/tool-catalog.md)**
...
|----------|---------------|
| [Manual](docs/manual/index.md) | Complete reference: architecture, all 492 tools, workflows |
