...
<p align="center">
  ...
  393 tools. 50 domains. Device atlas. Splice integration. Auto-composition. Spectral perception. Technique memory.
</p>
...
12 engines sit on top of the 393 tools. They give the AI musical judgment, not just musical execution.
...
393 tools across 50 domains. Highlights below — [full catalog here](docs/manual/tool-catalog.md).
...
> **[View all 393 tools →](docs/manual/tool-catalog.md)**
...
|----------|---------------|
| [Manual](docs/manual/index.md) | Complete reference: architecture, all 393 tools, workflows |
