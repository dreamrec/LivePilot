...
<p align="center">
  ...
  490 tools. 56 domains. Device atlas. Plan-aware Splice integration. Auto-composition. Spectral perception. Technique memory. Drum-rack pad builder. Live dead-device detection.
</p>
...
Pick whichever is faster for the idea in your head — both reach the same 490-tool surface.
...
12 engines sit on top of the 490 tools. They give the AI musical judgment, not just musical execution.
...
490 tools across 56 domains. Highlights below — [full catalog here](docs/manual/tool-catalog.md).
...
> **[View all 490 tools →](docs/manual/tool-catalog.md)**
...
|----------|---------------|
| [Manual](docs/manual/index.md) | Complete reference: architecture, all 490 tools, workflows |
