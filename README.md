...
<p align="center">
  ...
  397 tools. 51 domains. Device atlas. Splice integration. Auto-composition. Spectral perception. Technique memory.
</p>
...
12 engines sit on top of the 397 tools. They give the AI musical judgment, not just musical execution.
...
397 tools across 51 domains. Highlights below — [full catalog here](docs/manual/tool-catalog.md).
...
> **[View all 397 tools →](docs/manual/tool-catalog.md)**
...
|----------|---------------|
| [Manual](docs/manual/index.md) | Complete reference: architecture, all 397 tools, workflows |
