...
LivePilot is an MCP server that controls Ableton Live 12 in real-time through 76 tools across 9 domains. This document maps every tool to what it actually does in Ableton, so you know exactly which tool to reach for.
...
### Transport (10) — Playback, tempo, global state
